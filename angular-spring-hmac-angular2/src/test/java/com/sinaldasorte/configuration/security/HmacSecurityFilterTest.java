...
import com.sinaldasorte.configuration.security.WrappedRequest;
...
public class HmacSecurityFilterTest {
    ...
    public void setUp() throws HmacException, IOException {
        ...
        hmacToken = HmacSigner.getSignedToken(secret,String.valueOf("1"),20,new HashMap<String, String>(){/**
			 * 
			 */
			private static final long serialVersionUID = 5562255879728022182L;

		{put(HmacSigner.ENCODING_CLAIM_PROPERTY, HmacUtils.HMAC_SHA_256);}});
