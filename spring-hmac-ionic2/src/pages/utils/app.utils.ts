...
// export const BACKEND_API_ROOT_URL: string = 'http://localhost:8084/hmac' + BACKEND_API_PATH;
// export const BACKEND_API_ROOT_URL: string = 'http://192.168.0.12:8084/hmac' + BACKEND_API_PATH;

export class UrlMatcher {
	public static matches(url: string): boolean {
		return url.indexOf(BACKEND_API_PATH) !== -1 && url.indexOf(BACKEND_API_PATH + BACKEND_API_AUTHENTICATE_PATH) === -1;
	}
}
